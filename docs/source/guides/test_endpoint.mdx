...
The Endpoint overview provides you access to the Inference Widget, which can be used to send requests as we did in 6. of [Create your first Endpoint](/docs/inference-endpoints//guides/guides/create_endpoint). This allows you to quickly test your Endpoint with different inputs and share it with team members. \
