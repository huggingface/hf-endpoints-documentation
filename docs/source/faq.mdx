...
Note that if your model takes a long time to initialize, autoscaling may not be effective. This is because the average GPU utilization may fall below the threshold, which triggers the automatic scaling down of your endpoint.
