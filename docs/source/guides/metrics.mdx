...
The Hugging Face Inference Endpoints API exposes a [route to access the metrics](/docs/guides/api_reference#getendpointmetrics) of your Endpoints. You can use this route to send customized Prometheus queries to your Endpoints.