...
- "What's the recommended config for `meta-llama/Llama-3.2-1B-Instruct`?"
- "Pause my `llama-3-2-1b` endpoint to stop billing."
- "Show me the last hour of error logs for `my-endpoint`."
