...
### 1. Got to the upgrade link: [https://huggingface.co/subscribe/lab](https://huggingface.co/subscribe/lab) 

### 2. Select the organization you want to upgrade and click “next.

<Tip>

Note: If you are not seeing your organization, it means you already have a plan.
...
### 6. Now you can access the solution at: [https://ui.endpoints.huggingface.co/](https://ui.endpoints.huggingface.co/) 
