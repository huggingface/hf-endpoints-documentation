...
<Tip>
The Analytics section in the guide goes you can read more about how to track all the metrics mentioned in this documentation.
</Tip>
...
You can also track the hardware utilisation metrics in the Analytics tab, or read more about it [here](./metrics#hardwareutilisation).
...
And similarly to the hardware metrics you can track the pending request in the Analytics tab, or read more about it [here](./metrics#pendingrequests).
