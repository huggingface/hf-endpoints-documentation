...
| -------- | ------------- | ----------- | ---- | ------ | ------------ | ----------------------- |
| aws      | small         | $0.500      | 1    | 14GB   | NVIDIA T4    | aws-g4dn-xlarge-small   |
| aws      | medium        | $1.000      | 1    | 24GB   | NVIDIA A10G  | aws-g5-2xlarge-medium   |
| aws      | large         | $3.000      | 4    | 56GB   | NVIDIA T4    | aws-g4dn-12xlarge-large |
| aws      | xlarge        | $4.000      | 1    | 80GB   | NVIDIA A100  | aws-p4de-xlarge         |
| aws      | xxlarge       | $5.000      | 4    | 96GB   | NVIDIA A10G  | aws-g5-12xlarge-xxlarge |
| aws      | 2xlarge       | $8.000      | 2    | 160GB  | NVIDIA A100  | aws-p4de-2xlarge        |
| aws      | 4xlarge       | $16.000     | 4    | 320GB  | NVIDIA A100  | aws-p4de-4xlarge        |
| aws      | 8xlarge       | $32.000     | 8    | 640GB  | NVIDIA A100  | not available           |
| gcp      | x1            | $0.500      | 1    | 24GB   | NVIDIA T4    | gcp-nvidia-t4-x1        |
| gcp      | x1            | $1.000      | 1    | 24GB   | NVIDIA L4    | gcp-nvidia-l4-x1        |
| gcp      | x4            | $5.000      | 4    | 96GB   | NVIDIA L4    | gcp-nvidia-l4-x4        |
| gcp      | x1            | $6.000      | 1    | 80 GB  | NVIDIA A100  | gcp-nvidia-a100-x1      |
| gcp      | x2            | $12.000     | 2    | 160 GB | NVIDIA A100  | gcp-nvidia-a100-x2      |
| gcp      | x4            | $24.000     | 4    | 320 GB | NVIDIA A100  | gcp-nvidia-a100-x4      |
| gcp      | x8            | $48.000     | 8    | 640 GB | NVIDIA A100  | gcp-nvidia-a100-x8      |
