...
The Logs page in give yous monitoring and debugging capabilities for your deployed models. This view allows you to track the
...
![banner](https://raw.githubusercontent.com/huggingface/hf-endpoints-documentation/update/large-rewrite/assets/logs/logs.png)

## Deployment Status Overview

At the top of the logs interface, you'll find deployment information that provides an at-a-glance view of your endpoint's current
state. The deployment status section shows the deployment identifier (6pajyw3k) and replica information (z7ghx), along with the combined
deployment-replica identifier (6pajyw3k-z7ghx).

Next to the filter you'll find a statu indicator. The interface also tracks important timestamps, showing when the endpoint was started and
