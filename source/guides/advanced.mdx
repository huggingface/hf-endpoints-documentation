...
We have seen how fast and easy it is to deploy an Endpoint in [Create your first Endpoint](https://todo), but that’s not all you can manage. During the creation process and after selecting your Cloud Provider and Region, click on the [Advanced configuration] button to reveal further configuration options for your Endpoint.
...
Select a [supported Machine Learning Task](https://todo), or set to [Custom](https://todo). [Custom](https://todo) can/should be used when you are not using a Transformers-based model or when you want to customize the inference pipeline, see [Create your own Inference handler](https://todo).
...
More on how to ["Use your own custom container"](https://todo) below.
