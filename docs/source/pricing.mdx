...
| Provider | Instance Type | Instance Size | Hourly rate | Accelerators | GPU Memory | RAM     | Architecture     |
| -------- | ------------- | ------------- |------------ | ------------ | ---------- | ------- | ---------------- |
| aws      | inf2          | x1            | $0.75       | 1            | 32 GB      | 14.5 GB | AWS Inferentia2  |
| aws      | inf2          | x12           | $12         | 12           | 384 GB     | 760 GB  | AWS Inferentia2  |
| gcp      | tpu           | 1x1           | $1.38       | 1            | 16 GB      | 44 GB   | GCP TPUv5e       |
| gcp      | tpu           | 2x2           | $5.5        | 4            | 64 GB      | 190 GB  | GCP TPUv5e       |
| gcp      | tpu           | 2x4           | $11         | 8            | 128 GB     | 380 GB  | GCP TPUv5e       |
