...
<div class="flex md:justify-start mb-2 text-gray-400 items-center">
  <a href="https://endpoints.huggingface.co/new">
...
Listed available quota can now be seen in the Inference dashboard at https://endpoints.huggingface.co under "Quotas Used". 
