...
The Endpoint overview provides access to the Inference Widget which can be used to send requests. This allows you to quickly test your Endpoint with different inputs and share it with team members. In addition, the Inference Widget has an additional option for creating your request as a cURL command and copying it so you can easily share or use it.
