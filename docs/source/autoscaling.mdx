...
It's important to note that the scaling up process takes place every minute, and the scaling down process takes up to 2 minutes. This frequency ensures a balance between responsiveness and stability of the autoscaling system, with a stabilization of 300 seconds once scaled up or down. 
