...
This document describes the configuration options available when creating a new inference endpoint. Each section of
...
information we recommend reading the [in-depth guide on autoscaling](./guides/autoscaling).
