...
<img src="https://raw.githubusercontent.com/huggingface/hf-endpoints-documentation/blob/main/assets/0_token.png" alt="add token" />

3. Now you can create your [first Endpoint](/guides/create_endpoint)
