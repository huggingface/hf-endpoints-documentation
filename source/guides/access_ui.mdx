...
![login](https://github.com/huggingface/hf-endpoints-documentation/blob/main/assets/0_login.png)

2. Enter your Token in [https://ui.endpoints.huggingface.co/](https://ui.endpoints.huggingface.co/) 

![add token](https://github.com/huggingface/hf-endpoints-documentation/blob/main/assets/0_token.png)
