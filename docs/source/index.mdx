...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  <a 
    class="!no-underline pb-8 block rounded-xl border border-gray-200 dark:border-gray-800 bg-gradient-to-br from-red-50 to-white dark:from-red-900/20 dark:to-gray-900/10 hover:shadow-xl transition-all leading-none"
    href="./quick_start.mdx"
    >
