...
Inference Endpoints is built with security and secure inference at its core. Below you can find an overview of the security measures
we have in place.
...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/hub/security-soc-1.jpg" alt="soc-1" style={{ maxWidth: "300px", width: "100%" }} />
</div>
...
the AWS account ID of the account which also should have access to Inference Endpoints.
