...
Select a [supported Machine Learning Task](/docs/inference-endpoints//guides/supported_tasks), or set to [Custom](/docs/inference-endpoints//guides/guides/custom_handler). [Custom](/docs/inference-endpoints//guides/guides/custom_handler) can/should be used when you are not using a Transformers-based model or when you want to customize the inference pipeline, see [Create your own Inference handler](/docs/inference-endpoints//guides/guides/custom_handler).
...
More on how to ["Use your own custom container"](/docs/inference-endpoints//guides/guides/custom_handler) below.
