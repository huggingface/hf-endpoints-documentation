...
| -------- | ------------- | ------------- | ----------- | ----- | ------ | --------------------- |
| aws      | intel-icl     | x1            | $0.032      | 1     | 2GB    | Intel Ice Lake        | (Soon to be deprecated)
| aws      | intel-icl     | x2            | $0.064      | 2     | 4GB    | Intel Ice Lake        | (Soon to be deprecated)
| aws      | intel-icl     | x4            | $0.128      | 4     | 8GB    | Intel Ice Lake        | (Soon to be deprecated)
| aws      | intel-icl     | x8            | $0.256      | 8     | 16GB   | Intel Ice Lake        | (Soon to be deprecated)
